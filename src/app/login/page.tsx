...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-amber-50 dark:bg-background">
        <header className="bg-background dark:bg-[#1a2535] text-foreground p-4 flex justify-between items-center border-b border-border shadow-md">
            <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-semibold text-primary font-playfair">New Era University</span>
            </div>
        ...
        <footer className="bg-background dark:bg-[#1a2535] text-muted-foreground p-4 text-center text-xs border-t border-border shadow-[0_-2px_6px_rgba(0,0,0,0.06)]">
